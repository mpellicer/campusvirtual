...
public abstract class VPreguntaEnqGrp extends HtmlPanelGrid
{
	...
	public VPreguntaEnqGrp() {};
	
	public VPreguntaEnqGrp(PreguntaEnqGrp pregunta, String id, HashMap respostes, List<Integer> enq_codnum, String dni)
	{
...
//		htmlText.setValue(numero+".- "+vtext);
