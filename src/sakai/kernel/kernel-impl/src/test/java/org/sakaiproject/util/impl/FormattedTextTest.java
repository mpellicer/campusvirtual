...
public class FormattedTextTest {
    ...
    public void testProcessAnchor() {
    	...
    	Assert.assertEquals("<a  href=\"http://sakaiproject.org/\" target=\"_blank\" rel=\"noopener\" rel=\"noopener\">", formattedText
    ...
    public void testTargetNotOverridden() {
    	...
    	Assert.assertEquals("<a  href=\"other.html\" target=\"_blank\" rel=\"noopener\">", 
                formattedText.processAnchor("<a target=\"_blank\" rel=\"noopener\" href=\"other.html\">") );
    ...
    public void testAntisamyProcessFormattedText() {
        ...
        //Assert.assertTrue( result.contains("target=\"_blank\" rel=\"noopener\"")); // adds target in
    ...
    public void testStripHtmlFromText() {
     ...
     public void testKNL_1530() {
         ...
         String expectedAnchor = "<a href=\"http://sakaiproject.org/\" target=\"_blank\" rel=\"noopener\" rel=\"noopener\">sakaiproject</a>";
