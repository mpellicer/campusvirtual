 ...
 * Class Questionari
 */
public class QuestionariEnqGrp {
	...
	public QuestionariEnqGrp(int codnum, String desid1, String desid2, String desid3, int ordre, String visible){
