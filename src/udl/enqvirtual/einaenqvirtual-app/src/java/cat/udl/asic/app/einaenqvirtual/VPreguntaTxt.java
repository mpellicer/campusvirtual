...
public class VPreguntaTxt extends VPregunta
{	
	...
	public VPreguntaTxt(PreguntaTxt pregunta, String id, HashMap respostes, HashMap hmEnq_codnum, HashMap hmPrg_codnum, HashMap hmTipus_prg,List<Integer> enq_codnum, String dni)
	{
